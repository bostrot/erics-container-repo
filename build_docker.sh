...
do
    ...
    echo `docker buildx build --push --platform linux/amd64,linux/arm/v7,linux/arm64,linux/386,linux/ppc64le,linux/riscv64,linux/s390x --tag bostrot/$folder_name:latest $folder`
done;
