...
do
    ...
    echo `docker buildx build --push --platform linux/amd64,linux/arm64,linux/riscv64,linux/ppc64le,linux/386,linux/arm/v7 --tag bostrot/$folder_name:latest --tag bostrot/$folder_name:latest $folder`
done;
